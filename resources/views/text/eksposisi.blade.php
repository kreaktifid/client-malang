...
<body>
		...
		<div class="container-fluid" style="text-align: center;width: 90%;">
			<div class="row">
				<div class="col-md-12 test">
					<div class="button-place" style="display: flex;
									  justify-content: space-between;
									  align-items: flex-end;">
						<button class="ui grey right floated labeled icon button" onclick="window.location.href='/index.php'"> 
	...
	<footer id="footer" style="background-color: #000;margin-top: 100px;">
		<div class="container">
			<div class="col-md-12">
				<h4 class="text-center" style="color: #fff;">Kreaktif 2019. Hak Cipta Dilindungi</h4>
			</div>
		</div>
	</footer>
